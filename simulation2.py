...
from utils import *
import time
# using Fresnel propagation with spectrum method FFT+IFFT
...
plt.imsave("Image5_1.png",I,cmap='gray')
...
plt.imsave("Image6_1.png",I_crop,cmap='gray')
