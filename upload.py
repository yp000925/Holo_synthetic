...
if __name__ == '__main__':
    ...
    base_root = '/home/ypzhang/exp/holo_data/512_50_particle'
    make_dirs(base_root)
    ...
    for n in tqdm(range(0,hologram_number)):
        ...
        particles.to_csv(base_root+"/param/%d.csv"% n, index=False)
        holo = generate_holo_fromcsv2(base_root+"/param/%d.csv"% n)
