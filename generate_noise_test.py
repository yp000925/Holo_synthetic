# this is the script for generate the coco dataset of 512x512 image size with Gaussian noise
...
if __name__ == '__main__':
    ...
    import json
    json_name = '/Users/zhangyunping/PycharmProjects/Holo_synthetic/noise_check.json'
